      ...
      <div className="flex flex-row h-screen bg-gray-100">
        <div className="flex flex-col justify-between items-center flex-none w-16 bg-gray-200">
          <div className="flex flex-col space-y-4 w-full items-center pt-5">
            ...
            <a href="/#"className="block relative w-full h-16 w-16 flex justify-center items-center">
        ...
        <div className="w-64 flex-none bg-gray-100 p-4 flex flex-col space-y-4">
          <div className="flex flex-row justify-between items-center mb-6">
            ...
            <svg className="flex-none w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
          </div>
        ...
        <div className="flex flex-row flex-auto bg-white rounded-tl-xl border-l shadow-xl">
          ...
          <div className="w-3/5 border-l border-r border-gray-400 flex flex-col">
            ...
            <div className="flex-none h-40 p-4 pt-0">
              <textarea value="" className="w-full h-full outline-none border focus:border-blue-600 hover:border-blue-600 rounded p-4 shadow-lg">Hi</textarea>
            </div>
          </div>
